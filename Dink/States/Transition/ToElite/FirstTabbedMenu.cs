...
{
    class FirstTabbedMenu : State
    {
        /// <summary>
        /// 
        /// </summary>
        /// <param name="data"></param>
        public FirstTabbedMenu(IConfiguration data) : base(data)
        {
            ushort.TryParse(_data["pixels:first_tabbed_menus:coords:x"], out ushort x);
            ushort.TryParse(_data["pixels:first_tabbed_menus:coords:y"], out ushort y);
            Sig = new Signifier
            {
                Color = _data["pixels:first_tabbed_menus:color"],
                X = x,
                Y = y
            };
