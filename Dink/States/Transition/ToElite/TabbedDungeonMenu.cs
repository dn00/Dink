...
{
    class TabbedDungeonMenu : State
    {
        /// <summary>
        /// 
        /// </summary>
        /// <param name="data"></param>
        public TabbedDungeonMenu(IConfiguration data) : base(data)
        {
            ushort.TryParse(_data["pixels:tabbed_dungeon_menus:coords:x"], out ushort x);
            ushort.TryParse(_data["pixels:tabbed_dungeon_menus:coords:y"], out ushort y);
            Sig = new Signifier
            {
                Color = _data["pixels:tabbed_dungeon_menus:color"],
                X = x,
                Y = y
            };
